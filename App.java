...
public class App {
	...
	public static String fichierDestination = "hdfs://localhost:9000/hdfslog";

	public static int frequence = 1;

	public static final String quartierVip = "inara";
